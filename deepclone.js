...
function cloneObject(obj, sources, clones) {
  ...
  properties.forEach(function (property) {
    ...
    descriptor.value = _getValue2Assign(
      descriptor.value,
      obj,
      target,
      sources,
...
function _getValue2Assign(value, objectBeingCloned, target, sources, clones) {
  if (!isObject(value)) {
    ...
    if (
      target &&
      value.constructor.prototype.isPrototypeOf(clone.constructor.prototype)
    ) {
      return target;
    }
    return _getObjectValue2Assign(
      value,
      objectBeingCloned,
      target,
      sources,
...
function _getObjectValue2Assign(
  value,
  objectBeingCloned,
  target,
  sources,
